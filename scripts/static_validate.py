...
require(len(migrations) == 8, 'exactly eight Package 09.1 migrations')
require(len(tests) == 3, 'exactly three Package 09.1 pgTAP suites')
...
assertion_pattern = re.compile(
    ...
    r'is|ok|lives_ok|throws_ok|results_eq)\s*\('
)
for path in tests:
