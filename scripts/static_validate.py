...
def strip_client_project_detail_progress_terms(text, rel_path):
    ...
    for approved in (
        ...
        'clientProjectPhaseTasksProvider',
        ...
        'current_client_project_phase_completion',
        'current_client_project_phases',
        'current_client_project_tasks',
        ...
        'getClientProjectPhaseCompletion',
        ...
        '_ProgressUpdateCard',
        'Project phases',
        'Project phases could not be loaded.',
        'No project phases or tasks are available yet.',
...
for path in package_12_1_scope_files:
    if path.exists() and path.is_file():
        ...
        for forbidden in package_12_1_global_exclusion_markers:
            ...
            allowed_stage_12_owner_admin_photograph_gateway_marker = (
                forbidden == 'thumbnail'
                and path.name in {
                    '20260724112200_1179_owner_admin_photograph_gallery_gateway.sql',
                    '103_stage_12_owner_admin_photograph_gallery_gateway.test.sql',
                }
                and 'thumbnail_available' in text
            )
