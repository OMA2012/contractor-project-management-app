...
SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000003201', (SELECT id FROM app.projects WHERE name = 'Task Assignment Project'), 'Assignable Task', NULL, NULL, 'private description', 'client summary');
SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000003201', (SELECT id FROM app.projects WHERE name = 'Task Assignment Other Project'), 'Other Task');
