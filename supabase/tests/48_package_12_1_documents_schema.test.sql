...
SELECT ok(NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'app' AND table_name IN ('payment_requests','project_expenses','currency_exchanges')), 'placeholder finance tables absent except Package 14.1 client payments');
