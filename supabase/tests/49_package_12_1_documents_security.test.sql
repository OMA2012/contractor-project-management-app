...
SELECT ok(NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'app' AND table_name IN ('storage_buckets','document_scans','document_thumbnails','project_expenses','currency_exchanges')), 'storage scanner thumbnail finance objects absent except Package 14.1 client payments and Package 14.2 payment requests');
