...
SELECT lives_ok($$ INSERT INTO app.documents (storage_bucket, storage_object_key, original_file_name, mime_type, file_size_bytes, sha256_hash, document_type_code, client_visible, notes, uploaded_by) VALUES ('metadata-only', 'documents/a.pdf', 'a.pdf', 'application/pdf', 100, decode('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'hex'), 'GENERAL', true, 'visible', (SELECT id FROM app.users WHERE auth_subject='00000000-0000-0000-0000-000000005001')) $$, 'trusted fixture creates first finalized document metadata');
SELECT lives_ok($$ INSERT INTO app.documents (storage_bucket, storage_object_key, original_file_name, mime_type, file_size_bytes, sha256_hash, document_type_code, client_visible, notes, uploaded_by) VALUES ('metadata-only', 'documents/b.pdf', 'b.pdf', 'application/pdf', 200, decode('bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb', 'hex'), 'CONTRACT', false, NULL, (SELECT id FROM app.users WHERE auth_subject='00000000-0000-0000-0000-000000005001')) $$, 'trusted fixture creates second finalized document metadata');
...
SELECT throws_ok($$ INSERT INTO app.documents (storage_bucket, storage_object_key, original_file_name, mime_type, file_size_bytes, sha256_hash, document_type_code, uploaded_by) VALUES ('metadata-only', 'documents/c.pdf', 'c.pdf', ' ', 100, decode('cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc', 'hex'), 'GENERAL', (SELECT id FROM app.users WHERE auth_subject='00000000-0000-0000-0000-000000005001')) $$, '23514', 'new row for relation "documents" violates check constraint "documents_mime_type_ck"', 'blank mime type rejected');
SELECT throws_ok($$ INSERT INTO app.documents (storage_bucket, storage_object_key, original_file_name, mime_type, file_size_bytes, sha256_hash, document_type_code, uploaded_by) VALUES ('metadata-only', 'documents/c.pdf', 'c.pdf', 'text/plain', 0, decode('cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc', 'hex'), 'GENERAL', (SELECT id FROM app.users WHERE auth_subject='00000000-0000-0000-0000-000000005001')) $$, '23514', 'new row for relation "documents" violates check constraint "documents_file_size_bytes_ck"', 'nonpositive file size rejected');
SELECT throws_ok($$ INSERT INTO app.documents (storage_bucket, storage_object_key, original_file_name, mime_type, file_size_bytes, sha256_hash, document_type_code, uploaded_by) VALUES ('metadata-only', 'documents/c.pdf', 'c.pdf', 'text/plain', 1, decode('cccc', 'hex'), 'GENERAL', (SELECT id FROM app.users WHERE auth_subject='00000000-0000-0000-0000-000000005001')) $$, '23514', 'new row for relation "documents" violates check constraint "documents_sha256_hash_ck"', 'non-32-byte hash rejected');
SELECT throws_ok($$ SELECT * FROM public.server_owner_create_document_metadata('00000000-0000-0000-0000-000000005001', 'metadata-only', 'documents/c.pdf', 'c.pdf', 'text/plain', 1, decode('cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc', 'hex'), 'general', false, NULL) $$, '42501', 'Document metadata creation requires secure upload finalization.', 'legacy metadata creation gateway is restricted');
