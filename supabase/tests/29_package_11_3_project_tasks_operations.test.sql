...
SELECT results_eq(
  $$ SELECT task_number, status, completion_percent, is_active, version_number FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project One'), ' First Task ', (SELECT id FROM app.project_phases WHERE name = 'Task Phase Visible'), (SELECT id FROM app.project_milestones WHERE name = 'Task Milestone Visible'), 'secret task description', 'client summary one', 20, true, DATE '2026-02-05', DATE '2026-03-10', true, 'req-task', 'corr-task') $$,
  $$ VALUES ('TSK-0001'::text, 'TODO'::text, 0::numeric, true, 1) $$,
  'Owner creates first task with initial workflow state'
);
SELECT results_eq(
  $$ SELECT task_number FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project One'), 'Second Task', NULL, NULL, NULL, NULL, 20, true) $$,
  $$ VALUES ('TSK-0002'::text) $$,
  'second task receives next Project-local number'
);
SELECT results_eq(
  $$ SELECT task_number FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project Two'), 'Other Project First Task', NULL, NULL, NULL, NULL, 20, true) $$,
...
SELECT throws_ok($$ INSERT INTO app.tasks (project_id, task_number, title, weight_percent, counts_toward_completion, created_by, updated_by) VALUES ((SELECT id FROM app.projects WHERE name = 'Task Project One'), 'TSK-0001', 'Duplicate Task Number', 20, true, (SELECT id FROM app.users WHERE auth_subject = '00000000-0000-0000-0000-000000002901'), (SELECT id FROM app.users WHERE auth_subject = '00000000-0000-0000-0000-000000002901')) $$, '23505', NULL, 'duplicate task number rejected within one Project');
SELECT lives_ok($$ INSERT INTO app.tasks (project_id, task_number, title, weight_percent, counts_toward_completion, created_by, updated_by) VALUES ((SELECT id FROM app.projects WHERE name = 'Task Project Other Client'), 'TSK-0001', 'Same Local Number Different Project', 20, true, (SELECT id FROM app.users WHERE auth_subject = '00000000-0000-0000-0000-000000002901'), (SELECT id FROM app.users WHERE auth_subject = '00000000-0000-0000-0000-000000002901')) $$, 'same task number is allowed in a different Project');
...
SELECT throws_ok($$ SELECT * FROM public.server_update_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.tasks WHERE title = 'First Task Updated'), 1, 'Stale Task', NULL, NULL, NULL, NULL, 20, true) $$, '40001', 'Project task version conflict.', 'stale task update rejected');
SELECT throws_ok($$ SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project One'), 'Cross Project Phase', (SELECT id FROM app.project_phases WHERE name = 'Task Other Phase'), NULL, NULL, NULL, 20, true) $$, '23514', 'Project task phase must belong to the same Project.', 'cross-Project phase rejected safely');
SELECT throws_ok($$ SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project One'), 'Mismatched Milestone Phase', (SELECT id FROM app.project_phases WHERE name = 'Task Phase Hidden'), (SELECT id FROM app.project_milestones WHERE name = 'Task Milestone Visible'), NULL, NULL, 20, true) $$, '23514', 'Project task phase must match the milestone phase.', 'milestone phase compatibility enforced');
SELECT throws_ok($$ SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project One'), 'Project Date Outside', NULL, NULL, NULL, NULL, 20, true, DATE '2025-12-31') $$, '23514', 'Project task dates must fit inside Project dates.', 'Project-bound task date validation works');
SELECT throws_ok($$ SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project One'), 'Phase Date Outside', (SELECT id FROM app.project_phases WHERE name = 'Task Phase Visible'), NULL, NULL, NULL, 20, true, NULL, DATE '2026-06-01', true) $$, '23514', 'Project task dates must fit inside Project phase dates.', 'phase-bound task date validation works');
SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project One'), 'Hidden Phase Task', (SELECT id FROM app.project_phases WHERE name = 'Task Phase Hidden'), NULL, NULL, 'hidden phase task summary', 20, true, DATE '2026-06-10', DATE '2026-06-20', true);
SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project One'), 'Hidden Milestone Task', NULL, (SELECT id FROM app.project_milestones WHERE name = 'Task Milestone Hidden'), NULL, 'hidden milestone task summary', 20, true);
...
SELECT * FROM public.server_create_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.projects WHERE name = 'Task Project Two'), 'Phase Only Guard Task', (SELECT id FROM app.project_phases WHERE name = 'Task Other Phase'), NULL, NULL, NULL, 20, true);
...
SELECT throws_ok($$ SELECT * FROM public.server_update_project_task('00000000-0000-0000-0000-000000002901', (SELECT id FROM app.tasks WHERE title = 'First Task Updated'), 4, 'Inactive Edit', NULL, NULL, NULL, NULL, 20, true) $$, '23514', 'Project task cannot be updated.', 'inactive task update rejected');
