...
SELECT ok(NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'app' AND table_name IN ('completion_overrides','financial_transactions','ledger_entries')), 'finance tables remain absent');
